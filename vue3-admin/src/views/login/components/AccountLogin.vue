...
import ImeSafeInputOtp from './ImeSafeInputOtp.vue'
...
async function loadCaptcha() {
  const { base64, key } = await authApi.fetchCaptcha()
...
:deep(.el-input__inner) {
  ...
  /* caret-color: #eee; */
  /* box-shadow: inset 0 0 0 1000px #091c3d !important; */
}
:deep(input::-webkit-input-placeholder) {
  -webkit-text-fill-color: #5f757f !important;
}
:deep(.el-input__inner) {
